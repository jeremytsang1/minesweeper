...
- Note that in this particular implementation mines will not be laid until the player firsts opens a cell. This is a usability measure to prevent the player from dying on their first cell opening. Mines are laid randomly with the only non-random position being the first cell that the player opens.
